...
describe('Testing authenticate function', ()=>{
    ...
    it('Returns token when email and password are correct',async()=>{
        ...
        const result = authService.authenticate({email:user.email,password:user.password})
    ...
    it('Returns 401 when password is incorrect',async()=>{
        ...
        const result = authService.authenticate({email:user.email,password:user.password+'x'})
